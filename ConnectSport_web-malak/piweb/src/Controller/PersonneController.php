...
class PersonneController extends AbstractController
{
    ...
    /**
     * @Route("/personne/recherche1", name="triAdminNom")
     */
...
// profil respo
    ...
    /**
     * @Route("/personne/mobile", name="mobile_personne")
     */
    ...
    public function AllUsers(NormalizerInterface $normalizer)
    {
        ...
        $jsonContent=$normalizer->normalize($personnes,'json',['groups'=>'post:read']);

        return new Response(json_encode($jsonContent));
    }

    /**
     * @Route("/personne/mobileajout",name="mobile_ajout")
     */

    public function addUser(NormalizerInterface  $normalizer,Request $request)
    {
        $entityManager=$this->getDoctrine()->getManager();
        $p =new Personne();
    ...
    /**
     * @Route("/personne/mobilesupprimer/{id}",name="mobile_supprimer")
     */

    public function supprimerUser(NormalizerInterface  $normalizer,Request $request,$id)
    {
        $entityManager=$this->getDoctrine()->getManager();
        $repo=$this->getDoctrine()->getRepository(Personne::class);
        $p=$repo->find($id);
    ...
    /**
     * @Route("/personne/loginMobile",name="mobile_login")
     */
    ...
    public function signinAction(Request $request)
    {
        ...
        $em=$this->getDoctrine()->getManager();
        $user=$em->getRepository(Personne::class)->findOneBy(['mail'=>$mail]);
        //var_dump($user);
        ...
        if($user)
        {
           // if(password_verify($mdp,$user->getMdp())){
            if($mdp==$user->getMdp()){
                ...
                return new Response("mdp inconnue");
            }
...
/**
 * @Route("/personne/getPasswordByEmail",name="mobile_mdp")
 */
public function getPasswordByEmail(Request $request)
{
    $mail=$request->get('mail');
    $user=$this->getDoctrine()->getRepository(Personne::class)->findOneBy(['mail'=>$mail]);
    if($user)
    {
        $mdp=$user->getMdp();
        $serializer=new Serializer([new ObjectNormalizer()]);

...
// end mail
 ...
 public function excel(PersonnelRepository $repo)
 {
    ...
    /**
     * @Route("/personnel/mobile", name="mobile_personnel")
     */

    public function Allpersonnels(NormalizerInterface $normalizer)
    {
        $repository=$this->getDoctrine()->getRepository(Personnel::class);
        $personnels=$repository->findAll();
        $jsonContent=$normalizer->normalize($personnels,'json',['groups'=>'post:read']);

        return new Response(json_encode($jsonContent));
    }

    /**
     * @Route("/personnel/mobileajout",name="mobile_ajoutpers")
     */

    public function addPersonnel(NormalizerInterface  $normalizer,Request $request)
    { $idp=$request->query->get('idrespo');
        $user=$this->getDoctrine()->getRepository(Personne::class)->find($idp);

        $entityManager=$this->getDoctrine()->getManager();
        $p =new Personnel();
        $p->setCin($request->get('cin'));
        ...
        $p->setSalaire($request->get('salaire'));
    ...
    /**
     * @Route("/personnel/mobilesupprimer/{id}",name="mobile_supprimerperso")
     */

    public function supprimerpersonnel(NormalizerInterface  $normalizer,Request $request,$id)
    {
        $entityManager=$this->getDoctrine()->getManager();
        $repo=$this->getDoctrine()->getRepository(Personnel::class);
        $p=$repo->find($id);
        ...
        $entityManager->flush();
        $jsonContent=$normalizer->normalize($p,'json',['groups'=>'post:read']);
        return new Response("personnel supprimer".json_encode($jsonContent));
    }
}
